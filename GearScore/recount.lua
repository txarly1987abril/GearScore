...
function GearScore_Recount:TooltipFuncsGearScore(name,data)
	...
	if hps > dps then
		GameTooltip:AddLine( "Rendimiento de Sanación / GearScore: ".. (floor((hps * 100) / GS_GearScore)) )
	else
		GameTooltip:AddLine( "Rendimiento de Daño / GearScore: ".. (floor((dps * 100) / GS_GearScore)) )
	end
